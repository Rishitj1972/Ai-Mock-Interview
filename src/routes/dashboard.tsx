  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error) => {
        ...
        toast.error("Error...", {
          description:
            "There was an error fetching your interviews. Please try again later.",
        });
        setLoading(false);
      }
    );
      ...
      <div className="md:grid md:grid-cols-3 gap-3 py-4">
        {loading ? (
          ...
          interviews.map((interview) => (
            <InterviewPin key={interview.id} interview={interview} /> //InterviewPin is a created component
          ))
        ) : (
